...
import static control.file.UploadFileChildAvatar.ERORR;
import static control.file.UploadFileChildAvatar.SUCCESS;
...
public class FileUploadDob extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idUser = request.getParameter("idUser1");
        if (fileName.isEmpty() && !(fileName.endsWith(".jpg") || fileName.endsWith(".png"))) {
            ...
            ChildDB.updateImageDobChild(id, name);
