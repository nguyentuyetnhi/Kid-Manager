...
import static control.file.FileUploadServlet.ERROR;
import static control.file.FileUploadServlet.SUCCESS;
...
public class FileUploadCertificate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (fileName.isEmpty() && !(fileName.endsWith(".jpg") || fileName.endsWith(".png"))) {
            ...
            UsersDB.updateCertificate(id, name);
