...
public class ProposalView extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(proIdProposal != null){
               request.setAttribute("proIdProposal", proIdProposal);
        request.getRequestDispatcher(response.encodeURL("proposalView.jsp")).forward(request, response);
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ProposalView.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
