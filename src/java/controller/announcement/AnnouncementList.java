 ...
 * @author PC
 */
public class AnnouncementList extends HttpServlet {
    ...
    public static final String SUCCESS = "announcement.jsp";
...
//            request.setAttribute("msq", "Registration success !!!");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
             ...
             Logger.getLogger(AnnouncementList.class.getName()).log(Level.SEVERE, null, ex);
         }
    }
