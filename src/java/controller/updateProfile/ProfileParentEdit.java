 ...
 * @author PC
 */
public class ProfileParentEdit extends HttpServlet {
     ...
     */
    public static final String SUCCESS = "profileParent_Edit.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ProfileParentEdit.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
