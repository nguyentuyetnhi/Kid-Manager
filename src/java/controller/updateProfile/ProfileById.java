 ...
 * @author PC
 */
public class ProfileById extends HttpServlet {
    ...
    public static final String ERORR = "usersList.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userRequest != null) {
            ...
            listChild = ChildDB.getChildbyIdParent(userRequest.getIdUser().trim());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ProfileById.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
