 ...
 * @author ASUS-PRO
 */
public class SkillClassList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ChildDB c = new ChildDB();
         SkillListDB s = new SkillListDB();
          model.skillList.SkillList list1 = s.getAllSkillById(id);
      
          Users  user = UsersDB.getUserById(list1.getIdTeacher());
            List<Child> childList1 = c.getAllChildByIdSkill(id, "Accept    ");
